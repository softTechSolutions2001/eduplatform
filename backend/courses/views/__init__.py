...
from .public import (
    ...
    CourseViewSet,
    LessonViewSet,
    ModuleViewSet as PublicModuleViewSet,  # Renamed to avoid collision
...
ModuleViewSet = PublicModuleViewSet  # COMPATIBILITY: Provide backward compatibility alias
...
from .draft_content import (
    # Original draft content viewset from instructor portal
    DraftCourseContentViewSet,

    # New viewsets for course drafts
    DraftCourseViewSet,
    DraftModuleViewSet,
    DraftLessonViewSet,
...
if settings.DEBUG:
    ...
    class CacheStatsView(SecureAPIView):
        def get(self, request, *args, **kwargs):
            ...
            return Response({'error': 'This endpoint is only available in DEBUG mode'},
