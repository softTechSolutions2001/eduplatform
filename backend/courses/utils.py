#
# File Path: backend/courses/utils.py
# Folder Path: backend/courses/
# Date Created: 2025-06-15 06:41:03
# Date Revised: 2025-06-17 16:44:48
# Current Date and Time (UTC): 2025-06-17 16:44:48
# Current User's Login: sujibeautysalon
# Author: sujibeautysalon
# Last Modified By: sujibeautysalon
# Last Modified: 2025-06-17 16:44:48 UTC
# User: sujibeautysalon
# Version: 3.0.0
#
# Production-Ready Utility Functions for Course Management System
#
...
# - FIXED: Access control logic duplication - consolidated into validation.py
# - FIXED: Security vulnerabilities in HTML processing and file handling
# - FIXED: Performance issues with analytics calculations and queries
# - FIXED: Race conditions in slug generation and certificate creation
# - FIXED: Input validation and sanitization throughout
# - ADDED: Comprehensive error handling and logging
# - ADDED: Caching layer for expensive operations
# - ADDED: Atomic operations for data integrity
# - ENHANCED: File handling security and validation
...
def generate_certificate_number(course_id: int, user_id: int, timestamp=None) -> str:
    ...
    try:
        ...
        return f"CERT-{course_id:06d}-{user_id:06d}-{timestamp_str}"
...
__all__ = [
    ...
    'update_course_analytics', 'generate_unique_slug', 'clean_html_content',
    'extract_text_from_html', 'calculate_reading_time', 'get_file_extension',
    'is_video_file', 'is_image_file', 'is_document_file', 'validate_file_security',
    'validate_json_field', 'upload_course_thumbnail', 'upload_lesson_resource',
