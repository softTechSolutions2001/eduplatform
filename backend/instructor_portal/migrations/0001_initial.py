...
import instructor_portal.models
import uuid
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('courses', '0002_courseprogress_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('website', models.URLField(blank=True, validators=[instructor_portal.models.HTTPSURLValidator()], verbose_name='Website')),
                ('linkedin_profile', models.URLField(blank=True, validators=[instructor_portal.models.HTTPSURLValidator()], verbose_name='LinkedIn Profile')),
                ('twitter_handle', models.CharField(blank=True, max_length=50, verbose_name='Twitter Handle')),
                ('profile_image', models.ImageField(blank=True, null=True, upload_to=instructor_portal.models.generate_upload_path, verbose_name='Profile Image')),
                ('cover_image', models.ImageField(blank=True, null=True, upload_to=instructor_portal.models.generate_cover_upload_path, verbose_name='Cover Image')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_method', models.CharField(choices=[('wizard', 'Step-by-Step Wizard'), ('ai_builder', 'AI Course Builder'), ('drag_drop', 'Drag & Drop Builder'), ('template', 'Template-Based'), ('import', 'Content Import')], max_length=30)),
                ('status', models.CharField(choices=[('draft', 'Draft - In Progress'), ('paused', 'Paused - Resumed Later'), ('validating', 'Validating Content'), ('ready_to_publish', 'Ready for Publishing'), ('published', 'Published Successfully'), ('failed', 'Creation Failed'), ('abandoned', 'Abandoned Session')], default='draft', max_length=30)),
                ...
                ('draft_course', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='active_sessions', to='courses.course')),
                ('published_course', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='creation_session', to='courses.course')),
                ('reference_courses', models.ManyToManyField(blank=True, related_name='referenced_in_creation', to='courses.course')),
                ('instructor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='creation_sessions', to='instructor_portal.instructorprofile')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template_type', models.CharField(choices=[('beginner', 'Beginner Course Template'), ('intermediate', 'Intermediate Course Template'), ('advanced', 'Advanced Course Template'), ('workshop', 'Workshop Template'), ('masterclass', 'Masterclass Template'), ('certification', 'Certification Course Template')], max_length=30)),
                ...
                ('created_date', models.DateTimeField(auto_now_add=True)),
                ('updated_date', models.DateTimeField(auto_now=True)),
                ('category', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='templates', to='courses.category')),
            ...
            options={
                ...
                'indexes': [models.Index(fields=['category', 'template_type'], name='instructor__categor_346b2d_idx'), models.Index(fields=['is_active', '-usage_count'], name='instructor__is_acti_adf2a1_idx')],
            },
        ),
        migrations.CreateModel(
            ...
            options={
                ...
                'indexes': [models.Index(fields=['session', 'content_type'], name='instructor__session_60ca31_idx'), models.Index(fields=['session', 'order'], name='instructor__session_126edb_idx'), models.Index(fields=['session', 'content_type', 'version'], name='instructor__session_ab2b78_idx'), models.Index(fields=['is_complete', 'last_saved'], name='instructor__is_comp_5366a4_idx')],
        ...
        migrations.AddIndex(
            model_name='coursecreationsession',
            index=models.Index(fields=['expires_at', 'status'], name='instructor__expires_9cd11e_idx'),
        ),
        migrations.AddIndex(
